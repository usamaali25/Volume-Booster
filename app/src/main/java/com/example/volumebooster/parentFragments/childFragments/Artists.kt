...
class Artists : Fragment() {
    ...
    override fun onCreateView(
        ...
        view1 = inflater.inflate(R.layout.fragment_artists, container, false)
        addView(view1)
        return view1
    }
    ...
    private fun addView(view1: View?) {
        ...
        recyclerView = view1?.findViewById(R.id.artists_recycler_view) as RecyclerView
        recyclerView.layoutManager = LinearLayoutManager(view1.context)
        adapter = ArtistsAdapter(tempAudioList, view1.context)
